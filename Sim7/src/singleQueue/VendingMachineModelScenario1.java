...
public class VendingMachineModelScenario1 extends Model{
	...
	public VendingMachineModelScenario1(Model owner, String name, boolean showInReport, boolean showInTrace) {
	...
	public static void main(String[] args) {
		...
		VendingMachineModelScenario1 vendingModel = new VendingMachineModelScenario1(null, "VendingMachine-Model", true, true);
